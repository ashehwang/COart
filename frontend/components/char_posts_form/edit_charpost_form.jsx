...
class EditCharPostForm extends React.Component {
    
  constructor(props) {
    super(props);
    this.state = this.props.characterPost;
  ...
  handleSubmit(e){
      ...
      this.props.updateCharacterPost(formData, this.state.id);
...
export default EditCharPostForm;