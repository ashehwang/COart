json.community do
    json.extract! @community, :id, :admin_id, :name, :status, :recruiting, :visibility, :intro, :detail, :url, :membership_request_ids, :member_ids, :created_at, :applying_character_ids
...
json.characters do
    # if @community.applying_characters
